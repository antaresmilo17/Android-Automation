...
public class TestConfig {
    ...
    public static class Environment {
        ...
        public static String getPassword() { return config.getString("environment." + getName() + ".account.password"); }

        public static String getUserEmail(String user) { return config.getString("environment." + getName() + "." + user + ".email"); }

        public static String getUserPassword(String User) { return config.getString("environment." + getName() + "." + User + ".password"); }

        public static String getUserFirstName(String User) { return config.getString("environment." + getName() + "." + User + ".firstName"); }
...
//                secretKey = config.getString("environment." + getName() + ".secret");
        ...
        public static String getUserLastName(String User) { return config.getString("environment." + getName() + "." + User + ".lastName"); }

        public static String getUserDisplayName(String User) { return config.getString("environment." + getName() + "." + User + ".displayName"); }
        ...
        public static String getValidData(String messageType) { return config.getString("environment."+getName()+ ".ValidData." + messageType); }

        public static String getUserToken(String User) { return config.getString("environment."+getName()+ "." + User + ".token"); }

        public static String getOrgToken() { return config.getString("environment."+getName()+ ".orgToken"); }

        public static String getGroupToken() { return config.getString("environment."+getName()+ ".groupToken"); }
    }
}